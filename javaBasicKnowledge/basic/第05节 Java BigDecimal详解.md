...
![aliBigDecimalOps01.png](img/05/aliBigDecimalOps01.png)
...
相关issue：[建议对保留规则设置为 RoundingMode.HALF_EVEN,即四舍六入五成双,#2129](https://github.com/Snailclimb/JavaGuide/issues/2129) 。
